  ...
  return h(
    ...
    h(
      ...
      h(
        ...
        h("button", { className: "remote-btn-sm power-remote", onClick: onPower, tabIndex: 0, title: "Power" }, "PWR"),
        h("div", { className: "remote-brand" }, "FRACTAL TV"),
        h("button", { className: "remote-close-btn", onClick: onClose, tabIndex: 0 }, "X"),
      ),
      h(
        "div",
        ...
        h(
          ...
          h(
            ...
            { className: "dpad-grid" },
            h("div"),
            h("button", { className: "remote-btn-sm dpad-btn", onClick: onChannelUp, tabIndex: 0, title: "Channel Up" }, "â–²"),
            h("div"),
            h("button", { className: "remote-btn-sm dpad-btn", onClick: onVolumeDown, tabIndex: 0, title: "Volume Down" }, "â—„"),
            h("button", { className: "remote-btn-sm dpad-ok", onClick: onMenu, tabIndex: 0, title: "OK / Menu" }, "OK"),
            h("button", { className: "remote-btn-sm dpad-btn", onClick: onVolumeUp, tabIndex: 0, title: "Volume Up" }, "â–º"),
            h("div"),
            h("button", { className: "remote-btn-sm dpad-btn", onClick: onChannelDown, tabIndex: 0, title: "Channel Down" }, "â–¼"),
            h("div"),
          ),
          h(
            "div",
            ...
            h("button", { className: "remote-fn-btn", onClick: onFavorites, tabIndex: 0 }, "â˜… FAV"),
          ),
        ),
        h(
          "div",
